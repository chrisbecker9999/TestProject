...
void AEnemy::CheckPatrolTarget()
{
	...
	{
		//UE_LOG(LogTemp, Warning, TEXT("Checking patrol target"));
...
{
	//UE_LOG(LogTemp, Warning, TEXT("Checking combat target"));
...
bool AEnemy::InTargetRange(AActor* Target, double Radius)
{
	...
	//DRAW_SPHERE_SingleFrame_Radius(GetActorLocation(), PatrolRadius);
...
void AEnemy::SpawnDefaultWeapon()
{
	...
	if (World)
	{
		...
		DefaultWeapon->Equip(GetMesh(), FName("KnightRightHandSocket"), this, this);
